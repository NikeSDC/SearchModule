...
const Converse = () => (
  <div className="headerLogo">
      <a aria-label="Converse" data-type="click_navBrandBar" data-path="Converse" className="headerLogo" href="https://www.nike.com/w/converse-shoes-akmjxzy7ok" data-pre="ILink">
