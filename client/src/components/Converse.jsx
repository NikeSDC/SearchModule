...
let Converse = () => (
  <div>
    <li class="pre-brand-item">
      <a aria-label="Converse" data-type="click_navBrandBar" data-path="Converse" class="pre-brand-item d-sm-ib prl3-sm" href="https://www.nike.com/w/converse-shoes-akmjxzy7ok" data-pre="ILink">
