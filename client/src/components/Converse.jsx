...
let Converse = () => (
  <div>
    <li className="pre-brand-item">
      <a aria-label="Converse" data-type="click_navBrandBar" data-path="Converse" className="pre-brand-item d-sm-ib prl3-sm" href="https://www.nike.com/w/converse-shoes-akmjxzy7ok" data-pre="ILink">
