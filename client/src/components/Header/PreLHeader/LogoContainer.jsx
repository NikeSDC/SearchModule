...
// import Jordan from './Logos/Jordan.jsx';
// import Converse from './Logos/Converse.jsx';

const LogoContainer = () => (
  <ul className="pre-brand-menu d-sm-h d-md-flx">
    <li className="pre-brand-item">
      <a aria-label="Jordan" data-type="click_navBrandBar" data-path="Jordan" className="pre-brand-item d-sm-ib prl3-sm" href="https://www.nike.com/jordan" data-pre="ILink">
