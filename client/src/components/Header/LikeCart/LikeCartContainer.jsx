...
const LikeCartContainer = () => (
  <div className="likeCartContainer">
    <a aria-label="Favorites" title="Favorites" data-var="favoritesLink" data-type="click_navShortcut" data-path="favorites" className="heartIcon pre-btn-header ripple mr3-sm d-sm-h d-lg-ib" href="https://www.nike.com/favorites" data-pre="ILink">
...
export default LikeCartContainer;
