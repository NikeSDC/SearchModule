...
const PreDesktopMenu = () => (
  <div className="pre-l-desktop-menu d-sm-h d-lg-b ta-sm-l ta-lg-c">
    <ul className="pre-desktop-menu" data-pre="DesktopMenu">
      <li className="pre-desktop-menu-item d-lg-ib is-static is-header">
        <a aria-label="New Releases" data-nav="0,0,-1" role="menu" aria-expanded="false" aria-controls="DesktopMenu-0-0-0" data-type="click_navShoppingMenu" data-path="new releases" className="pre-desktop-menu-link headline-5 prl3-lg pt4-sm d-sm-b no-outline" href="https://www.nike.com/w/new-3n82y" data-pre="ILink">
          New Releases
        </a>
