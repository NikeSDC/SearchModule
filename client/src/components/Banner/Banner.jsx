      ...
      <div className="banner-carousel-wrapper css-196tcw2 css-1yoeq20">
        <div className="css-kswtif" data-orientation="horizontal" data-hero="true" data-slides-to-show="1" data-scrollable="false" data-should-transition="true" data-semantically-hide-unobserved-cards="true" data-conditionally-hide-nav-buttons="false" data-with-tracker="false" data-with-navigation="true" autoplay="" id="">
          <ul className="slider">
            ...
            <li aria-hidden="false" data-in-view="true" data-index="1" className="slide selected">
              <div className="banner-node css-gb9zhi">
          ...
          <button data-automation="carousel-nav-prev" aria-label="Previous" className="carousel-btn prev-btn carousel-btn-floating-false css-1ciuivw">
            <div className="icon">
          ...
          <button data-automation="carousel-nav-next" aria-label="Next" className="carousel-btn next-btn carousel-btn-floating-false css-1ciuivw">
            <div className="icon">
              <svg className="arrow-icon" aria-hidden="true" fill="#111" height="30px" width="30px" viewBox="0 0 185.4 300">
